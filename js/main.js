...
//TODO: change the key field (id or name) to link the views
var key = "Name";
...
d3.json("data/population-joined-map.geo.json", function(error, jsonData) {
  ...
  function highlight(data){
    ...
    var labelAttribute = "<h1>"+ roundRight(props[expressed]) + "%</h1><br><b>Population " + expressed + "</b>:" + props.Name+ ""; //label content
